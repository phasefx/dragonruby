/* Modified by Jason Etheridge for use in 3D Baffle, January 29, 2001 */
...
/* ---Modifications.  Exposing some internals.  1/29/01 */
void PolarLookFrom(GLfloat, GLfloat, GLfloat);
